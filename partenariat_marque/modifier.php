...
<header style="position: fixed; top: 0; width: 100%;">
    <nav>
        <ul>
            <div id="divheader1">
                <li class="listee"><a href="../partenariat_marque" class="headrr">M&I</a></li>
            </div>
            <div id="divheader2">
                <li class="liste"><a onclick="location.href='../partenariat_marque'" class="headr">RETOUR</a></li>
        ...
        <div id="formulaire">
            <form method="POST" action="insert.php">
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    $marqueQuery = "SELECT * FROM influenceur WHERE id = '$influencerId'";
                    $infResult = mysqli_query($conn, $marqueQuery);
                    $infData = mysqli_fetch_assoc($infResult);
                    $marqueName = $infData['lname']." ".$infData['fname'];
                }
                ?>
