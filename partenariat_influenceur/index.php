...
<head>
    ...
    <link rel="stylesheet" href="recherchepmar.css">
...
<section>
    ...
    <table class="new-offer-table">
        <tr>
            <td class="button-cell" onclick="window.open('../addpart_inf', '_blank');">
                Make New Offer
            </td>
        </tr>
    </table>
    ...
    <table>
        ...
        $query = "SELECT o.id, i.fname, i.lname, m.name AS marque, o.date_added, o.duration, o.content, o.price
              ...
              WHERE o.influencer_id = '$user_id' and o.sender='marque';";
        $result = mysqli_query($conn, $query);
    ...
    <br><br><br><br><br><br>
    <table>
        <caption><center>OFFRES Envoyee</center></caption>
        <tr>
            <th>id</th>
            <th>marque</th>
            <th>date_added</th>
    ...
    $query = "SELECT o.id, i.fname, i.lname, m.name AS marque, o.date_added, o.duration, o.content, o.price
              ...
              INNER JOIN marque m ON o.marque_id = m.id
              INNER JOIN influenceur i ON o.influencer_id = i.id
              WHERE o.influencer_id = '$user_id' and o.sender='influenceur';";
    $result = mysqli_query($conn, $query);
