...
<header style="position: fixed; top: 0; width: 100%;">
    <nav>
        <ul>
            ...
            <div id="divheader2">
                <li class="liste"><a href="#" class="headr" onclick="location.href='../partenariat_marque'">RETOUR</a></li>
    ...
    <center>
        <div id="formulaire">
            ...
            <form method="POST" action="insert.php">
                <h2>PARTENARIAT</h2>
                <select name="influenceur" required>
                    <?php
                    // Assuming you have a database connection
                    include ('database.php');

                    $result = mysqli_query($conn, "SELECT * FROM influenceur");
